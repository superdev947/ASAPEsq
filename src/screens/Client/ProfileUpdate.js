...
const ProfileUpdate = ({ navigation }) => {
	...
	const updateProfileApicall = async () => {
		...
		const response = await fetchs({
			url: Root.client_updateProfile_EndURL, body: {
			...
			<Content>
				...
				<Form style={{ marginLeft: 15, marginRight: 15, marginTop: 15 }}>
					...
					<View style={{ flexDirection: 'row', marginTop: 10 }}>
						...
						<Text style={{ fontWeight: 'bold', marginTop: 8 }}>Location</Text>
					</View>
					<Item>
					...
					<View style={{ flexDirection: 'row', marginTop: 10 }}>
						...
						<Text style={{ fontWeight: 'bold', marginTop: 8 }}>Mobile Number</Text>
					</View>
					<Item>
					...
					<View style={{ flexDirection: 'row', marginTop: 10 }}>
						...
						<Text style={{ fontWeight: 'bold', marginTop: 8 }}>Preferred Language</Text>
					</View>
					<Item>
					...
					<View style={{ flexDirection: 'row', marginTop: 10 }} >
						...
						<Text style={{ fontWeight: 'bold', marginTop: 8 }}>Time Clock</Text>
					</View>
					...
					<View style={{ flexDirection: 'row', marginTop: 10 }} >
						<Text style={{ marginTop: 8, color: '#FF0000' }}>Emergency Contact (Optional)</Text>
					</View>
					<Item style={{ marginTop: 1, marginLeft: 2, borderColor: '#fff' }} >
						<Image source={Images.p5} style={{ height: 35, width: 35 }} />
						<Input value={userInfo.emergency_name} onChangeText={e => setUserInfo({ ...userInfo, emergency_name: e })} placeholder="Full Name" />
					</Item>
					<Item style={{ marginTop: 1, marginLeft: 2, borderColor: '#fff' }} >
						<Image source={Images.mobile} style={{ height: 35, width: 35 }} />
						<Input value={userInfo.emergency_number} onChangeText={e => setUserInfo({ ...userInfo, emergency_number: e })} placeholder="Mobile" />
					</Item>
					<View style={{ marginLeft: 20, marginRight: 20 }}>
						<Button onPress={updateProfileApicall} full style={{ height: 50, marginTop: 20, backgroundColor: 'rgb(7, 77, 149)' }}>
							<Text style={{ fontSize: 16, color: "#fff" }}>UPDATE NOW</Text>
						</Button>
					</View>
